  ...
  return (
    <section className="relative px-6 py-28">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/2 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-claw-teal/8 blur-[150px]" />
      </div>

      <div className="relative z-10 mx-auto max-w-4xl">
        <div className="rounded-3xl border border-claw-teal/20 bg-card/60 p-12 text-center backdrop-blur-sm md:p-20">
